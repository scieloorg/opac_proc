...
for child in collection['children_ids']:
    ...
    if target_issn in target_issn_list:
        ...
        print("encontrei %s pids de issues do periódico %s para processar" % (len(issues_uuids), target_issn))
        print("encontrei %s pids de artigos do periódico %s para processar" % (len(articles_uuids), target_issn))
        ...
        print("enfilerados %s PIDs de issues do periódico %s" % (enqueued_issues_counts, issue_uuid))
        ...
        print("enfilerados %s PIDs de artigos do periódico %s" % (enqueued_articles_counts, article_uuid))
