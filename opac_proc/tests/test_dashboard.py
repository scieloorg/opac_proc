...
class TestRQDashboardView(BaseTestCase):

    def test_dashboard_page_redirect_to_login(self):
        """
    ...
    def test_dashboard_page_following_redirect_lands_on_login_page(self):
        """
